    ...
    <nav className="flex justify-around items-center bg-white p-5 space-x-20">
      <div className="flex items-center space-x-12">
        ...
        <div className="flex items-center justify-center space-x-8 ">
          ...
          <Link href="/articles" className="hover:text-yellow-300">
            مقالات
          </Link>
          <Link href="/aboutUs" className="hover:text-yellow-300">
            درباره ما
          </Link>
        </div>
      </div>
      ...
      <div className="flex space-x-2 justify-center items-center">
        {isLogged ? (
          <>
            <Image src={""} alt="dsadas" width={200} height={200} />
            <p>user</p>
          </>
        ) : (
          <>
            <button className="border-2 border-black px-10 py-2 rounded-md">
              ثبت نام
            </button>
            <button className="border-2 border-black px-10 py-2 rounded-md">
              ورود
